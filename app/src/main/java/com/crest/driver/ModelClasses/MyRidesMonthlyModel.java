 ...
 */
public class MyRidesMonthlyModel {
    ...
    public MyRidesMonthlyModel(String ride_id, String name, String date, String payment, String payment_type, String user_v_image) {
        this.name = name;
        this.date = date;
